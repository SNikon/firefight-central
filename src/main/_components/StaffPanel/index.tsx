...
export const StaffPanel: FunctionComponent<StaffPanelProps> = ({ internalId, onClose }) => {
	...
	const onStaffIdChange = (e: React.ChangeEvent<HTMLInputElement>) => setStaffId(e.target.value)
	const [staffName, setStaffName] = useState('')
	const onStaffNameChange = (e: React.ChangeEvent<HTMLInputElement>) => setStaffName(e.target.value)
	const [staffState, setStaffState] = useState(StaffState.Available)
	const onStaffStateChange = (e: React.ChangeEvent<HTMLSelectElement>) => setStaffState(e.target.value as StaffState)
